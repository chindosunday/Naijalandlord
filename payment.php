...
<section>
    ...
    <div class="row">
      <div class="col-md-4"></div>
        <div class="col-md-4">
            <h1>Pay for this Apartment</h1>
            <p>Please note that the amount you are about to pay has only a one year validity </p>
        </div>
        <div class="col-md-4"></div>
    </div>
...
<script src="../assets/scripts/jquery313.js" crossorigin="anonymous"></script>
...
<script>
    ...
    ref: "ujhbjhjhvnhgl", // Replace with a reference you generated
